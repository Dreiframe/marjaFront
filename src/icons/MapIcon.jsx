const MapIcon = ({width, height}) => {
    return(
        <svg width={width ? width : '100px'} height={height ? height : "80px"} viewBox="0 0 1024 1024" className="icon"  version="1.1" xmlns="http://www.w3.org/2000/svg">
            <path d="M318.7 233.66666667H165.1c-22.8 0-41.3 18.5-41.3 41.3v513.3c0 22.8 18.5 41.3 41.3 41.3h753.7c22.8 0 41.3-18.5 41.3-41.3V274.96666667c0-22.8-18.5-41.3-41.3-41.3H318.7z" fill="#A7B8C6" />
            ...
            <path d="M498.6 484.6m-188.9 0a188.9 188.9 0 1 0 377.8 0 188.9 188.9 0 1 0-377.8 0Z" fill="#FFFFFF" /><path d="M706.6 506.7H284.7c-4 0-7.3-3.3-7.3-7.3v-29.5c0-4 3.3-7.3 7.3-7.3h421.9c4 0 7.3 3.3 7.3 7.3v29.5c0 4-3.3 7.3-7.3 7.3z" fill="#FFFFFF" />
            <path d="M473.5 695.6V273.7c0-4 3.3-7.3 7.3-7.3h29.5c4 0 7.3 3.3 7.3 7.3v421.9c0 4-3.3 7.3-7.3 7.3h-29.5c-4 0-7.3-3.3-7.3-7.3z" fill="#FFFFFF" /><path d="M498.6 484.6m-152.9 0a152.9 152.9 0 1 0 305.8 0 152.9 152.9 0 1 0-305.8 0Z" fill="#4DA6D8" />
